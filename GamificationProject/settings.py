"""
Django settings for GamificationProj project.
...
ALLOWED_HOSTS = [env.get('ALLOSED_HOSTS')]
...
ROOT_URLCONF = 'GamificationProject.urls'
...
WSGI_APPLICATION = 'GamificationProject.wsgi.application'
